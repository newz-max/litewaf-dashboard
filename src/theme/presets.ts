...
export function buildCssVars(tokens: ThemeSurfaceTokens, settings: ThemeSettings) {
  ...
  return {
    ...
    "--lw-shell-bg": `linear-gradient(180deg, ${tokens.bgElevated} 0%, ${tokens.bg} 52%, color-mix(in srgb, ${tokens.bg} 88%, ${tokens.sider}) 100%)`,
    "--lw-shell-sider": `linear-gradient(180deg, color-mix(in srgb, ${tokens.sider} 90%, ${tokens.panelMuted}) 0%, ${tokens.sider} 62%, color-mix(in srgb, ${tokens.sider} 86%, ${tokens.bg}) 100%)`,
    "--lw-shell-header": `linear-gradient(180deg, color-mix(in srgb, ${tokens.header} 94%, ${tokens.panel}), color-mix(in srgb, ${tokens.header} 88%, ${tokens.bg}))`,
    "--lw-shell-content": `linear-gradient(180deg, ${tokens.bgElevated} 0%, ${tokens.bg} 48%, color-mix(in srgb, ${tokens.bg} 92%, ${tokens.panelMuted}) 100%)`,
    "--lw-shell-border": `color-mix(in srgb, ${tokens.border} 74%, transparent)`,
    "--lw-shell-surface": `color-mix(in srgb, ${tokens.panelMuted} 82%, transparent)`,
